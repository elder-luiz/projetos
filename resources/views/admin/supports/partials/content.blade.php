        ...
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
            <div class="overflow-hidden border border-gray-200 border-gray-700 md:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 divide-gray-700 dark:bg-gray-900">
                                ...
                                <div class="flex items-center">
                                    @foreach ($support->replies as $reply)
                                        ...
                                        @if ($loop->last && $loop->index > 4)
                                            <div class="object-cover w-6 h-6 -mx-1 border-2 border-white rounded-full dark:border-gray-700 shrink-0 bg-green-500">+{{ ($loop->count - 4) }}</div>
                                        @endif
                                    @endforeach
                                </div>
                            </td>
